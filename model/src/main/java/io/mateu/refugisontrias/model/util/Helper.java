...
import io.mateu.ui.mdd.server.util.*;
...
// Don't log exceptions inside FreeMarker that it will thrown at you anyway:
    ...
    public static void notransact(io.mateu.ui.mdd.server.util.JPATransaction t) throws Throwable {
    ...
    public static File writeTemp(String data) throws IOException {
        return writeTemp(UUID.randomUUID().toString());
    }

    public static File writeTemp(String archivo, String data) throws IOException {

        if (!archivo.contains(".")) archivo += ".txt";

        File temp = (System.getProperty("tmpdir") == null)?File.createTempFile(archivo.substring(0, archivo.indexOf(".")), archivo.substring(archivo.indexOf("."))):new File(new File(System.getProperty("tmpdir")), archivo.substring(0, archivo.indexOf(".")) + archivo.substring(archivo.indexOf(".")));
